                ...
                <div class="contenidoHeaderSuperior">
                    ...
                    <nav>
                        <ul class="menu">
                            ...
                            <li><a href="./PrivacyViejo.html">SOBRE NOSOTROS</a></li>
            ...
            <section class="componentes">
                ...
                <section>
                    <article class="componente">
                        <figure>
                            <a href="./ProductoViejo.html"><img src="./images/index/components/procesador.png" alt="IMG"></a>
                        </figure>
                        <h4>Alimentación</h4>
                    </article>
                    <article class="componente">
            ...
            <section class="ordenadores">
                ...
                <section>
                    <article class="ordenador">
                        <figure>
                            <a href="./ProductoViejo.html"><img src="./images/index/hardware/pcverde.png" alt="IMG"></a>
                        </figure>
                    </article>
                    <article class="ordenador">
                        <figure>
                            <a href="./ProductoViejo.html"><img src="./images/index/hardware/laptopverde.png" alt="IMG"></a>
                        </figure>
                    </article>
                    <article class="ordenador">
                        <figure>
