...
public class CajaDAO extends TablaDAO<Caja> {
    ...
    @Override
    public int anyadir(Caja objeto) throws SQLException {
        String sentenciaSQL = "INSERT INTO " + tabla + " VALUES(?,?,?,?)";
        PreparedStatement prepared = getPrepared(sentenciaSQL);
        prepared.setInt(1, objeto.getCodigo());
        prepared.setString(2, objeto.getSizeLitros());
        prepared.setString(3, objeto.getColor());
        prepared.setString(4, objeto.getConexion());
        return prepared.executeUpdate();
    }

    @Override
    public Caja eliminar(Caja objeto) throws SQLException {
        if (objeto == null) {
            return null;
        } else {
    ...
    @Override
    public boolean existe(Caja objeto) throws SQLException {
    ...
    public ArrayList<Caja> getAll() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            String size = resultSet.getString("size_case");
