...
VALUES (5463, 'sergiosanchez.alu@iespacomolla.es', '$2a$10$ABCDEFGHIJKLMNOPQRSTUOlaFx19206T5IdZAbVROsTEAtfCM.eri', 'Sergio Sanchez', 'https://i.imgur.com/drrIJO8.png', '688410654', to_date('27/01/1998', 'DD/MM/YYYY'), 'ADMIN');

INSERT INTO ps_usuario (codigo, email, pass, nombre_comp, foto, telefono, fecha_nacimiento, tipoUsuario)
VALUES (5464, 'longinoojeda.alu@iespacomolla.es', '$2a$10$ABCDEFGHIJKLMNOPQRSTUOlaFx19206T5IdZAbVROsTEAtfCM.eri', 'Longino Ojeda', 'https://i.imgur.com/drrIJO8.png', '688456765', to_date('15/04/2000', 'DD/MM/YYYY'), 'ADMIN');
